...
<body>
    <main class="container">
        ...
        <header class="d-flex flex-wrap align-items-center justify-content-center justify-content-md-between py-3 mb-4 border-bottom">
            <h1><a href="index.php" class="text-decoration-none text-dark">Flavour full plate</a></h1>

            <?php if (isset($_SESSION["user_email"])) //connected
            { ?>
                <ul class="nav col-12 col-md-auto mb-2 justify-content-center mb-md-0">
                    <li><a href="search_recipe.php" class="nav-link px-2 link-dark">Search Recipe</a></li>
                    <li><a href="add_recipe.php" class="nav-link px-2 link-dark">Add Recipe</a></li>
            ...
            <?php } else { //not connected ?>
                <ul class="nav col-12 col-md-auto mb-2 justify-content-center mb-md-0">
                    ...
                    <li><a href="register.php" class="nav-link px-2 link-dark">Sign-up</a></li>
                </ul>
            <?php } ?>
